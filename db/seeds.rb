...
Leg.create(origin: 'Chicago', destination: 'Charlotte', username: 'ArturTheHawk')
Leg.create(origin: 'Los Angeles', destination: 'Mexico City', username: 'DisasterAimiya',)
...
Leg.create(origin: 'Ann Arbor', destination: 'Chicago', username: 'StiffH20',)
